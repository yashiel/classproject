        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Update the artist's information and bring their profile to life with fresh details
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 p-8 lg:p-12">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-800">Editing {artist.name}</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-8 border-t border-gray-200/50">
                <button
                  type="submit"
                  disabled={saving}
                  className="flex-1 bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-4 px-6 rounded-xl font-semibold hover:from-indigo-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl"
                >
                  {saving ? (
